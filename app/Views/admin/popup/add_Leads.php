						...
						<div class="row">
							<div class="col-md-12 col-xs-12">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="startdate" id="exampleFormControlInput1">
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-md-12 col-xs-12">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="enddate" id="exampleFormControlInput1"></textarea>
								</div>
							</div>
						</div>
					</div>
