										...
										<ul id="dash_scrumboard" class="nav flex-column collapse nav-children">
											<li class="nav-item">
												<ul class="nav flex-column">
													...
													foreach ($menu_query->get()->getResult() as $key => $menuValue2) {
														if ($key > 3) {
															if ($menuValue2->has_submenu == 1 && parent_view($menuValue2->id)) {
...
<!-- 
				...
				<div class="nav-end-wrap">
					...
					<form class="dropdown navbar-search me-2" action="<?= base_url('/search')?>?" method="GET">
						...
						<div  class="dropdown-menu p-0">
							...
							<div data-simplebar class="dropdown-body p-2">
								...
								<div class="dropdown-item bg-transparent">
									...
									<button class="btn btn-secondary btn-sm" type="sumbit">Search</button>
